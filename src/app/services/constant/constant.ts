export const Constant = {
  ...
  API_END_POINT_Cart: 'http://localhost:8081/api/cart-items/',
  API_END_POINT_CATEGORY: 'http://localhost:8081/api/categories/',
  API_END_POINT_PRODUCTS: 'http://localhost:8081/api/products/',
  METHODS: {
